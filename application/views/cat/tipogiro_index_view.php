    ...
    <div class="card hoverable">
        ...
        <ul class="collection with-header">
            <li class="collection-header">
                <h4 class="center-align">Tipo Giro</h4>
            </li>

            <?php foreach ($registros as $reg): ?>
                <li class="collection-item">
                    <div>
                        <input class="check-status" type="checkbox" id="test<?= $reg->idtipogiro; ?>" data-value='<?= json_encode($reg); ?>' <?= $reg->activo > 0? 'checked': ''; ?>/>
                        <label for="test<?= $reg->idtipogiro; ?>"><?= $reg->descripcion; ?></label>
...
<div id="modal2" class="modal modal-fixed-footer">
    <div class="modal-content">
        ...
        <div class="row">
            <form action="<?= base_url('cat/tipogiro/create'); ?>" method="POST" id="form_create">
                ...
                <!-- campos ocultos -->
                <input type="hidden" name="idtipogiro" value="0">
...
<div id="modal1" class="modal modal-fixed-footer">
    <div class="modal-content">
        ...
        <div class="row">
            <form action="<?= base_url('cat/tipogiro/edit'); ?>" method="POST" id="form_edit">
                <div class="input-field col s12">
                ...
                <!-- campos ocultos -->
                <input type="hidden" name="idtipogiro" id="idtipogiro" value="0">
...
$(document).ready(function() {
    ...
    $(".btn-edit").click(function(event) {
        ...
        //console.log(json);
        $("#idtipogiro").val(json.idtipogiro);
    ...
    $(".check-status").change(function(event) {
        ...
        //console.log(json);
        $.ajax({
            url: "<?= base_url('cat/tipogiro/edit'); ?>",
            type: "POST",
            data: json
    ...
    $(".btn-delete").click(function(event) {
        ...
        .then((willDelete) => {
            if (willDelete) {
                //console.log(json);
                $.ajax({
                    url: "<?= base_url('cat/tipogiro/delete'); ?>",
                    type: "POST",
                    data: json
